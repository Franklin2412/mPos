...
public class RequestSentActivity extends AppCompatActivity implements
        SinVoiceRecognition.Listener, SinVoicePlayer.Listener {
    private final static String TAG = "RequestSentActivity";
...
//    private final static int TOKEN_LEN = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHanlder = new RequestSentActivity.RegHandler(this);
    ...
    private static class RegHandler extends Handler {
        ...
        private RequestSentActivity mAct;

        public RegHandler(RequestSentActivity act) {
            mAct = act;
        }
